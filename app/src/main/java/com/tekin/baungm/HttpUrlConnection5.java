 ...
 */
public class HttpUrlConnection5 extends AsyncTask {
    String paremeters;
    private final String USER_AGENT = "Mozilla/5.0";

    // HTTP GET request
    public HttpUrlConnection5(String paremeters){
    ...
    protected Object doInBackground(Object[] params) {
        ...
        try {
            post = sendPost("http://192.168.56.1:8080/gm_mesaj.php", paremeters);
        } catch (Exception e) {
            e.printStackTrace();
