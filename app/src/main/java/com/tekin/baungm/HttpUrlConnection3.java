 ...
 */
public class HttpUrlConnection3 extends AsyncTask {
    String paremeters;
    private final String USER_AGENT = "Mozilla/5.0";

    // HTTP GET request
        public HttpUrlConnection3(String paremeters){
    ...
    protected Object doInBackground(Object[] params) {
        ...
        try {
            post = sendPost("http://192.168.56.1:8080/uyegirisi.php", paremeters);
        } catch (Exception e) {
            e.printStackTrace();
