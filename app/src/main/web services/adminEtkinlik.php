...
if(isset($_POST['txtName']) && isset($_POST['txtTel'])){
	...
	$result=mysqli_query($con,"insert into etkinlik(baslik, yazi, date , image  ) values('$txtName', '$txtTel', '$txtDate' , '$txtMajor')");
...
<h1>Insert Data</h1>
	<form action="<?PHP $_PHP_SELF ?>" method="post">
		...
		Date <input type="text" name="txtDate" placeholder="Date" /> <br/> <br/>
